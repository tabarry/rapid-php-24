        ...
        array(
            ...
            'db' => array(
                ...
                'sulata_settings' => array(
                    ...
                    'setting__Setting' => array('name' => 'setting__Setting', 'label' => 'Setting', 'type' => 'text', 'length' => '32', 'required' => "required='required'", 'star' => '*', 'validateas' => 'text'),
                    'setting__Key' => array('name' => 'setting__Key', 'label' => 'Key', 'type' => 'text', 'length' => '32', 'required' => "required='required'", 'star' => '*', 'validateas' => 'text'),
                    'setting__Value' => array('name' => 'setting__Value', 'label' => 'Value', 'type' => 'text', 'length' => '32', 'required' => "required='required'", 'star' => '*', 'validateas' => 'text'),
