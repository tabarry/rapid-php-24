            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="head-user dropdown pull-right">
                    <a href="#" data-toggle="dropdown" id="profile">
                        ...
                        <?php if ($SESSION['userInfo']['user_picture'] != '') { ?>
                            <img src="<?php echo $SESSION['userInfo']['user_picture']; ?>" alt="<?php echo $SESSION['userInfo']['employee__Name']; ?>" class="img-responsive img-circle" />
                        <?php } else { ?>
                            <img src="<?php echo $BASE_URL ?>views/img/user.png" alt="<?php echo $SESSION['userInfo']['employee__Name']; ?>" class="img-responsive img-circle" />
                        <?php } ?>


                        <!-- User name -->
                        <?php echo $SESSION['userInfo']['employee__Name']; ?>
